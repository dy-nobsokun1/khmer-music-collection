...
const MusicPostcard = ({ entry }) => {
  ...
  return (
    ...
    >
      ...
      {/* Bottom-left corner */}
      <div style={{ ...cornerStyle, bottom: 0, left: 0, borderTop: "none", borderBottom: "4px solid #C1B19C" }} aria-hidden="true" />
      {/* Bottom-right corner */}
      <div style={{ ...cornerStyle, bottom: 0, right: 0, borderTop: "none", borderLeft: "none", borderBottom: "4px solid #C1B19C", borderRight: "4px solid #C1B19C" }} aria-hidden="true" />
